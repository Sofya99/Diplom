...
def Export_csv(request):
    ...
    if Export == 'Albedo':
        if res0:
            ...
            obj = next(serializers.deserialize("json", res0)).object
            writer.writerow([obj.Month_1, obj.Month_2, obj.Month_3, obj.Month_4, obj.Month_5, obj.Month_6, obj.Month_7, obj.Month_8,
             obj.Month_9, obj.Month_10, obj.Month_11, obj.Month_12])
    ...
    if Export == 'Sum':
        ...
        if res:
            ...
            for row in stat:
                writer.writerow(
                    [row.IdHour, row.Month_1, row.Month_2, row.Month_3, row.Month_4, row.Month_5, row.Month_6,
                     row.Month_7,
